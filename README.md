...
Second hand car marketplace where the users can search for their future car (client = default user). <br>
Users can post an add with their car making then a private seller. <br>
...
Car ad page will feature all photos of the car, technical details, description, list of options, location of the seller and his contact info. <br>
If you click on an ad from a private seller at the bottom you will see similar cars from the same make and model in the similar price range. <br>
